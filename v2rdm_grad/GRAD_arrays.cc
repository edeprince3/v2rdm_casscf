...
// Latest revision on April 28, 2013.
 /* COPIED FROM Ugur Bozkaya's DFOCC */
#include <stdio.h>
#include <libqt/qt.h>
...
void Array2d::contract(bool transa, bool transb, int m, int n, int k, const Array2d* a, const Array2d* b, double alpha, double beta)
{
    char ta = transa ? 't' : 'n';
    char tb = transb ? 't' : 'n';
    int nca, ncb, ncc;
...
void Array2d::contract323(bool transa, bool transb, int m, int n, const Array2d* a, const Array2d* b, double alpha, double beta)
{
    char ta = transa ? 't' : 'n';
    char tb = transb ? 't' : 'n';
    int k, nca, ncb, ncc;
...
void Array2d::contract233(bool transa, bool transb, int m, int n, const Array2d* a, const Array2d* b, double alpha, double beta)
{
    char ta = transa ? 't' : 'n';
    char tb = transb ? 't' : 'n';
    int k, lda, ldb, ldc;
...
void Array2d::sort1432(int d1, int d2, int d3, int d4, Array2d *A, Array2i *row_pair_idx, Array2i *col_pair_idx, Array2i *row_pair_idx2, Array2i *col_pair_idx2)
{
    for (int p = 0; p < d1; p++) {
         for (int q = 0; q < d2; q++) {
...
void Array2d::sort2134(int d1, int d2, int d3, int d4, Array2d *A, Array2i *row_pair_idx, Array2i *col_pair_idx, Array2i *row_pair_idx2)
{
    for (int p = 0; p < d1; p++) {
         for (int q = 0; q < d2; q++) {
              int pq = row_pair_idx->A2i_[p][q];
...
void Array2d::sort1243(int d1, int d2, int d3, int d4, Array2d *A, Array2i *row_pair_idx, Array2i *col_pair_idx, Array2i *col_pair_idx2)
{
    for (int p = 0; p < d1; p++) {
         for (int q = 0; q < d2; q++) {
              int pq = row_pair_idx->A2i_[p][q];
...
void Array2d::sort2413(int d1, int d2, int d3, int d4, Array2d *A, Array2i *row_pair_idx, Array2i *col_pair_idx, Array2i *row_pair_idx2, Array2i *col_pair_idx2)
{
    for (int p = 0; p < d1; p++) {
         for (int q = 0; q < d2; q++) {
              int pq = row_pair_idx->A2i_[p][q];
...
void Array2d::sort2143(int d1, int d2, int d3, int d4, Array2d *A, Array2i *row_pair_idx, Array2i *col_pair_idx, Array2i *row_pair_idx2, Array2i *col_pair_idx2)
{
    for (int p = 0; p < d1; p++) {
         for (int q = 0; q < d2; q++) {
              int pq = row_pair_idx->A2i_[p][q];
...
void Array2d::sort4231(int d1, int d2, int d3, int d4, Array2d *A, Array2i *row_pair_idx, Array2i *col_pair_idx, Array2i *row_pair_idx2, Array2i *col_pair_idx2)
{
    for (int p = 0; p < d1; p++) {
         for (int q = 0; q < d2; q++) {
              int pq = row_pair_idx->A2i_[p][q];
...
void Array2d::sort3142(int d1, int d2, int d3, int d4, Array2d *A, Array2i *row_pair_idx, Array2i *col_pair_idx, Array2i *row_pair_idx2, Array2i *col_pair_idx2)
{
    for (int p = 0; p < d1; p++) {
         for (int q = 0; q < d2; q++) {
              int pq = row_pair_idx->A2i_[p][q];
...
void Array2d::sortp1432(int d1, int d2, int d3, int d4, Array2d *A, Array2i *row_pair_idx, Array2i *col_pair_idx, Array2i *row_pair_idx2, Array2i *col_pair_idx2)
{
    for (int p = 0; p < d1; p++) {
         for (int q = 0; q < d2; q++) {
              int pq = row_pair_idx->A2i_[p][q];
...
void Array2d::sortp2134(int d1, int d2, int d3, int d4, Array2d *A, Array2i *row_pair_idx, Array2i *col_pair_idx, Array2i *row_pair_idx2)
{
    for (int p = 0; p < d1; p++) {
         for (int q = 0; q < d2; q++) {
              int pq = row_pair_idx->A2i_[p][q];
...
void Array2d::sortp1243(int d1, int d2, int d3, int d4, Array2d *A, Array2i *row_pair_idx, Array2i *col_pair_idx, Array2i *col_pair_idx2)
{
    for (int p = 0; p < d1; p++) {
         for (int q = 0; q < d2; q++) {
              int pq = row_pair_idx->A2i_[p][q];
...
void Array2d::sortp2413(int d1, int d2, int d3, int d4, Array2d *A, Array2i *row_pair_idx, Array2i *col_pair_idx, Array2i *row_pair_idx2, Array2i *col_pair_idx2)
{
    for (int p = 0; p < d1; p++) {
         for (int q = 0; q < d2; q++) {
              int pq = row_pair_idx->A2i_[p][q];
...
void Array2d::sortp2143(int d1, int d2, int d3, int d4, Array2d *A, Array2i *row_pair_idx, Array2i *col_pair_idx, Array2i *row_pair_idx2, Array2i *col_pair_idx2)
{
    for (int p = 0; p < d1; p++) {
         for (int q = 0; q < d2; q++) {
              int pq = row_pair_idx->A2i_[p][q];
...
void Array2d::sortp4231(int d1, int d2, int d3, int d4, Array2d *A, Array2i *row_pair_idx, Array2i *col_pair_idx, Array2i *row_pair_idx2, Array2i *col_pair_idx2)
{
    for (int p = 0; p < d1; p++) {
         for (int q = 0; q < d2; q++) {
              int pq = row_pair_idx->A2i_[p][q];
...
void Array2d::sortp3142(int d1, int d2, int d3, int d4, Array2d *A, Array2i *row_pair_idx, Array2i *col_pair_idx, Array2i *row_pair_idx2, Array2i *col_pair_idx2)
{
    for (int p = 0; p < d1; p++) {
         for (int q = 0; q < d2; q++) {
              int pq = row_pair_idx->A2i_[p][q];
...
Array2i* Array2i::generate(int d1,int d2)
{
